...
AFPSCharacter::AFPSCharacter()
{
	...
	noiseemittercomponent = CreateDefaultSubobject<UPawnNoiseEmitterComponent>(TEXT("NoiseComp"));
}
...
void AFPSCharacter::GetLifetimeReplicatedProps(TArray< FLifetimeProperty > & OutLifetimeProps) const
{
	...
	//DOREPLIFETIME_CONDITION(AFPSCharacter, bIscarringObject, COND_OwnerOnly);
}